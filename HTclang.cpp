...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    */
    ...
    if (isNotHTVMfile == 0) {
        ...
        for (size_t A_Index202 = 0; A_Index202 < items202.size() + 0; A_Index202++) {
            ...
            if (SubStr(A_LoopField202, 1, StrLen(keyWordComment)) == keyWordComment) {
                ...
                if (langToConvertTo == "cpp") {
                    htCode += getFuncTypeConvert(str3) + " " + str15 + "(char osp_osp_this_keyword_htvm_osp_this_htvm_keyword = " + Chr(34) + Chr(34) + ")" + Chr(10);
                }
                if (langToConvertTo == "py") {
                ...
                if (langToConvertTo == "cpp") {
                    htCode += "THERE IS NO catch IN C OK!!!! \n";
                }
                if (langToConvertTo == "py") {
                ...
                if (langToConvertTo == "cpp") {
                    htCode += "THERE IS NO throw IN C OK!!! \n";
                }
                if (langToConvertTo == "py") {
                ...
                if (langToConvertTo == "cpp") {
                    var1 = "for (size_t " + keyWordAIndex + "" + STR(AindexcharLength) + " = " + AHKlikeLoopsIndexedAt + "; ; " + keyWordAIndex + "" + STR(AindexcharLength) + "++)";
                }
                if (langToConvertTo == "go") {
                ...
                if (langToConvertTo == "cpp") {
                    var1 = "for (size_t " + keyWordAIndex + "" + STR(AindexcharLength) + " = " + AHKlikeLoopsIndexedAt + "; " + keyWordAIndex + "" + STR(AindexcharLength) + " < " + line + " + " + AHKlikeLoopsIndexedAt + "; " + keyWordAIndex + "" + STR(AindexcharLength) + "++)";
                }
                if (langToConvertTo == "go") {
                ...
                if (InStr(var1, keyWordEscpaeChar + ",")) {
                    ...
                    if (langToConvertTo == "cpp") {
                        itemsOut = "LoopParseFuncHelp items" + STR(AindexcharLength) + " = LoopParseFunc(" + line1 + ", " + line2 + Chr(44) + " " + Chr(34) + Chr(34) + ");";
                    }
                    if (langToConvertTo == "go") {
                    ...
                    if (line2 == "" && line3 == "") {
                        ...
                        if (langToConvertTo == "cpp") {
                            itemsOut = "LoopParseFuncHelp items" + STR(AindexcharLength) + " = LoopParseFunc(" + line1 + Chr(44) + " " + Chr(34) + Chr(34) + Chr(44) + " " + Chr(34) + Chr(34) + ");";
                        }
                        if (langToConvertTo == "go") {
                    ...
                    if (line2 != "" && line3 != "") {
                        ...
                        if (langToConvertTo == "cpp") {
                            itemsOut = "LoopParseFuncHelp items" + STR(AindexcharLength) + " = LoopParseFunc(" + line1 + ", " + line2 + ", " + line3 + ");";
                        }
                        if (langToConvertTo == "go") {
                            itemsOut = "items" + STR(AindexcharLength) + " := LoopParseFunc(" + line1 + ", " + line2 + ", " + line3 + ")";
                        }
                ...
                if (langToConvertTo == "cpp") {
                    var1out = itemsOut + Chr(10) + "for (size_t " + keyWordAIndex + "" + STR(AindexcharLength) + " = " + AHKlikeLoopsIndexedAt + "; " + keyWordAIndex + "" + STR(AindexcharLength) + " < items" + STR(AindexcharLength) + ".count + " + AHKlikeLoopsIndexedAt + "; " + keyWordAIndex + "" + STR(AindexcharLength) + "++)";
                }
                if (langToConvertTo == "go") {
                ...
                theFixTextLoopLP = "";
                if (langToConvertTo == "cpp") {
                    //const char* A_LoopField202 = items2.tokens[i];
                    theFixTextLoopLP = "const char* " + keyWordALoopField + "" + AindexcharLengthStr + " = items" + AindexcharLengthStr + ".tokens[" + keyWordAIndex + "" + AindexcharLengthStr + " - " + AHKlikeLoopsIndexedAt + "];";
                }
                if (langToConvertTo == "js") {
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        ...
        if (langToConvertTo == "cpp") {
            allLibsToPutAtTop = "#include " + Chr(60) + "stdint.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "ctype.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdio.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdlib.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "string.h" + Chr(62) + Chr(10) + "#include " + Chr(60) + "stdbool.h" + Chr(62) + Chr(10) + Chr(10) + allLibsToPutAtTop;
        }
        if (langToConvertTo == "cs") {
    ...
    htCode = StrReplace(htCode, "char(" + Chr(34) + Chr(34) + ";),", "char(" + Chr(34) + Chr(34) + "),");
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == "cpp" && includeLibsInCppIf == 0) {
            htCode = "#include " + Chr(60) + "stdint.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "ctype.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdio.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdlib.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "string.h" + Chr(62) + Chr(10) + "#include " + Chr(60) + "stdbool.h" + Chr(62) + Chr(10) +  Chr(10) + htCode;
        }
        if (langToConvertTo == "cs") {
...
void HTVMv2() {
    ...
    if (HTVM_getLang_HTVM() == "cpp" || HTVM_getLang_HTVM() == "py") {
        ...
        print(StringTrimRight(argCODEfile, StrLen(langFileExtension)) + "c");
        if (langToConvertTo == "js" && useJavaScriptInAfullHTMLfile == "on") {
            ...
            FileDelete(StringTrimRight(argCODEfile, StrLen(langFileExtension)) + "c");
            FileAppend(OUTCODE, StringTrimRight(argCODEfile, StrLen(langFileExtension)) + "c");
        }
    }
    if (HTVM_getLang_HTVM() == "js") {
        //print("JS")
