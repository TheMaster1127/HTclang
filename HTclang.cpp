...
std::string compiler(std::string htCode, std::string allInstructionFile, std::string mode, std::string langToConvertToParam = "") {
    ...
    */
    ...
    if (!(HTVM_Size(allFuncNames) <= 0)) {
        ...
        if (langToConvertTo == "cpp") {
            allLibsToPutAtTop = "#include " + Chr(60) + "ctype.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdio.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdlib.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "string.h" + Chr(62) + Chr(10) + "#include " + Chr(60) + "stdbool.h" + Chr(62) + Chr(10) + Chr(10) + allLibsToPutAtTop;
        }
        if (langToConvertTo == "cs") {
    ...
    if (isNotHTVMfile2 == 0) {
        ...
        if (langToConvertTo == "cpp" && includeLibsInCppIf == 0) {
            htCode = "#include " + Chr(60) + "ctype.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdio.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "stdlib.h" + Chr(62) + "" + Chr(10) + "#include " + Chr(60) + "string.h" + Chr(62) + Chr(10) + "#include " + Chr(60) + "stdbool.h" + Chr(62) + Chr(10) +  Chr(10) + htCode;
        }
        if (langToConvertTo == "cs") {
